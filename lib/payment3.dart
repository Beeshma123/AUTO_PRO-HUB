...
class Payment3 extends StatefulWidget {
   Payment3({super.key, required this.id});
  String id;
...
Future<dynamic> addData() async {
  ...
  print(data);
 var res = await post(Uri.parse('${Con.url}Payment3.php'),body: data);
 print(res.body);
 var r = jsonDecode(res.body);
  Fluttertoast.showToast(msg: 'Payment3 Completed successfully...');
